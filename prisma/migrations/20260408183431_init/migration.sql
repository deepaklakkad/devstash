...
-- CreateTable
CREATE TABLE "ItemsOnCollections" (
    "itemId" TEXT NOT NULL,
    "collectionId" TEXT NOT NULL,
    "addedAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,

    CONSTRAINT "ItemsOnCollections_pkey" PRIMARY KEY ("itemId","collectionId")
);
...
-- CreateIndex
CREATE INDEX "ItemsOnCollections_collectionId_idx" ON "ItemsOnCollections"("collectionId");
...
-- AddForeignKey
ALTER TABLE "ItemsOnCollections" ADD CONSTRAINT "ItemsOnCollections_itemId_fkey" FOREIGN KEY ("itemId") REFERENCES "Item"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ItemsOnCollections" ADD CONSTRAINT "ItemsOnCollections_collectionId_fkey" FOREIGN KEY ("collectionId") REFERENCES "Collection"("id") ON DELETE CASCADE ON UPDATE CASCADE;
